const data = [
    {id:1, title:"Domain-Specific Language Interpreter", img:"proj1.png", alt:"bnf specification", description:"A DSL Interpreter built in OCaml that follows a BNF design specification.", tech:["OCaml", "Menhir", "Dune"],
        modalDesc: [
    ...
    {id:2, title:"Second Nature", img:"proj2.png",  alt:"second nature logo", description:"Data analysis project identifying effective carbon reduction strategies for higher education institutions.", tech:["Python", "Pandas", "Numpy", "Matplotlib"], modalDesc: [
    ...
    {id:3, title:"Mass. HS Concussions Data Analysis", img:"proj3.png",  alt:"dataframe of mass highschools project", description:"Data pipeline and visualization of concussion trends across Massachusetts high schools.", tech:["Python", "Pandas", "Seaborn", "Matplotlib", "Nominatim", "Tableau"], modalDesc: [
    ...
    {id:6, title:"Keta App", img:"proj6.png",  alt:"login page of keta app", description:"A medication conflict checker that checks if interactions exist to help reduce potential adverse effects.", tech:["React", "Python", "Javascript", "Flask", "Firebase"], modalDesc: [
    ...
    {id:7, title:"Credit Card Fraud Detection AI Model", img:"proj7.png",  alt:"dataframe of the training data for the model", description:"Machine learning model that achieves 99% accuracy in detecting fraudulent transactions.", tech:["Python", "Pandas", "Scikit-Learn", "Seaborn", "Matplotlib", "Numpy"], modalDesc: [
    ...
    {id:8, title:"Throughput and Round-Trip Time App", img:"proj8.png",  alt:"code of the project", description:"Application measuring network performance metrics for improved connectivity analysis.", tech:["Java", "Python"], modalDesc: [
